...
import "../css/LifeStylePop.css";
import "../css/Models.css";

const montserrat = { fontFamily: "'Montserrat', Arial, Helvetica, sans-serif" };

export default function LifeStylePopup({ openLifeStylePopup, toggleLifeStylePopup }) {
    ...
    // Detect screen size and close popup when below XL
    useEffect(() => {
        const handleResize = () => {
            const width = window.innerWidth;
            const wasXL = screenSize === "xl";
            const isNowXL = width >= 1280;
            
            setScreenSize(isNowXL ? "xl" : "small");
            
            // If screen becomes smaller than XL and popup is open, close it
            if (wasXL && !isNowXL && openLifeStylePopup) {
                toggleLifeStylePopup(false);
            }
        };
    ...
    }, [screenSize, openLifeStylePopup, toggleLifeStylePopup]);
    ...
    useEffect(() => {
        if (openLifeStylePopup && menuModels.length > 0 && activeSection === "models") {
            setVisibleCount(0);
    ...
    }, [openLifeStylePopup, menuModels, activeSection]);
    ...
    if (!openLifeStylePopup && !animate && !isClosing) return null;
            ...
            <div className="fixed top-0 left-0 right-0 bg-white z-40">
                <div className="w-full flex items-center justify-between pl-12 pr-19 mt-11 mb-7 h-[60px] bg-white">
                    <div className="flex items-center gap-10">
                        ...
                        {/* Only show other nav items on XL screens */}
                        {isXLScreen && (
                            <>
                                <span 
                    ...
                    <div className="flex items-center gap-0">
                        ...
                        {/* Only show additional buttons on XL screens */}
                        {isXLScreen && (
                            <>
            ...
            <div className="pt-40 h-full custom-scrollbar-content">
                <div className="px-12 relative">
                    ...
                    <div 
                        ...
                        onClick={() => toggleLifeStylePopup(false)}
                    >
                    ...
                    {/* MODELS SECTION - ALWAYS VISIBLE ON ALL SCREENS */}
                    ...
                    {/* OTHER SECTIONS - ONLY ON XL SCREENS (1280px and above) */}
                    {isXLScreen && (
                        <>
                            {/* CULTURE SECTION */}
