...
import "../css/YourBentleyPopup.css";
import "../css/Models.css";

const montserrat = { fontFamily: "'Montserrat', Arial, Helvetica, sans-serif" };

export default function YourBentleyPopup({ openYourBentleyPopup, toggleYourBentleyPopup }) {
    const [animate, setAnimate] = useState(false);
    const [contentAnimate, setContentAnimate] = useState(false);
    const [isClosing, setIsClosing] = useState(false);
    const [activeSection, setActiveSection] = useState("yourBentley");
    ...
    useEffect(() => {
        if (openYourBentleyPopup && menuModels.length > 0 && activeSection === "models") {
            setVisibleCount(0);
    ...
    }, [openYourBentleyPopup, menuModels, activeSection]);

    useEffect(() => {
        if (openYourBentleyPopup) {
            setIsClosing(false);
            ...
            <div className="pt-40 h-full custom-scrollbar-content">
                <div className="px-12 relative">
                    ...
                    <div 
                        ...
                        onClick={() => toggleYourBentleyPopup(false)}
                    >
