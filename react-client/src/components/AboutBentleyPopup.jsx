...
import "../css/AboutBentleyPopup.css";
import "../css/Models.css";

const montserrat = { fontFamily: "'Montserrat', Arial, Helvetica, sans-serif" };

export default function AboutBentleyPopup({ openAboutBentleyPopup, toggleAboutBentleyPopup }) {
    const [animate, setAnimate] = useState(false);
    const [contentAnimate, setContentAnimate] = useState(false);
    const [isClosing, setIsClosing] = useState(false);
    const [activeSection, setActiveSection] = useState("aboutBentley");
    ...
    useEffect(() => {
        if (openAboutBentleyPopup && menuModels.length > 0 && activeSection === "models") {
            setVisibleCount(0);
    ...
    }, [openAboutBentleyPopup, menuModels, activeSection]);

    useEffect(() => {
        if (openAboutBentleyPopup) {
            setIsClosing(false);
            ...
            <div className="pt-40 h-full custom-scrollbar-content">
                <div className="px-12 relative">
                    ...
                    <div 
                        ...
                        onClick={() => toggleAboutBentleyPopup(false)}
                    >
                    ...
                    {/* MODELS SECTION - WITH ANIMATIONS AND KEYS */}
                    {activeSection === "models" && (
                        <div className="relative flex" style={{ height: "calc(100vh - 160px)" }}>
                            ...
                            {/* Right panel: detail WITH ANIMATIONS AND KEYS */}
                                ...
                                >
                                    <div className="pb-24">
                                        <div className="flex items-start gap-6 w-full">
                                            {/* LEFT column with animations and keys */}
                                            ...
                                            {/* RIGHT column with animations and key */}
                                            <div
