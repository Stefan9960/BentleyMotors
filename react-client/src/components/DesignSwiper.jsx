...
export default function DesignSwiper({
    slides,
    swiperRef,
    activeIndex,
    setActiveIndex,
                ...
                {slides.map((slide, index) => {
                    ...
                    return (
                        <SwiperSlide
                            ...
                            className={`design-slide-${slide.id} cursor-pointer`}
                            style={{
                                cursor: 'pointer',
                        ...
                        >
                            {/* ── Slide face text — bottom-left, matches Products/Heritage layout ── */}
                    ...
                    <div
                        ...
                        style={{
                            ...
                            animation: panelReady
                                ? (isLastTwo
                                    ? 'designSlideInLeft 0.45s cubic-bezier(0.32, 0.72, 0, 1)'
                                    : 'designSlideInRight 0.45s cubic-bezier(0.32, 0.72, 0, 1)')
                                : 'none',
                            ...(isLastTwo
                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 ml-auto">
                        <button
                            ...
                            className={`design-arrow rounded-full p-2 transition-none hover:bg-white/10 ${
